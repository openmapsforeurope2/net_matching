...
namespace app {
	namespace step {
		...
		///
		///
		void GenerateConnectingLinesByCountry::init()
		{
		...
		///
		///
		void GenerateConnectingLinesByCountry::onCompute( bool verbose = false )
		{
			//--
			...
			//--
			app::calcul::CFeatGenerationOp::GenerateConnectingLinesByCountry(countryCodeW, verbose);
